...
// 1.3: add a uniform variable here for camera uniforms (of type CameraUniforms)
...
fn main(in: VertexInput) -> VertexOutput
{
    ...
    // 1.3: transform by the view proj mat from your CameraUniforms uniform variable
